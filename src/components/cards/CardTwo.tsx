      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-2 md:py-2">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4 text-white text-2xl">Have A Team Of The Best</h2>
            <p className="text-xl text-blue-400 dark:text-white">Find The Answers To All Your Questions</p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            {/* 1st item */}
            <div className="relative flex flex-col items-center p-6 bg-inherit dark:bg-inherit rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">Talk with our team as your needs shift</p>
            </div>
  <div className="relative flex flex-col items-center p-6 bg-inherit rounded shadow-xl dark:bg-inherit">
              <svg className="w-16 h-16 p-1 -mt-1 mb-2" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                <g fill="none" fillRule="evenodd">
                  <rect className="fill-current text-zinc-400" width="64" height="64" rx="32" />
              ...
              <p className="text-gray-600 text-center">We are here to support your business and needs</p>
            </div>
            {/* 3rd item */}
            <div className="relative flex flex-col items-center p-6 bg-inherit rounded shadow-xl dark:bg-inherit">
              <svg className="w-16 h-16 p-1 -mt-1 mb-2" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
              ...
              <svg className="w-16 h-16 p-1 -mt-1 mb-2" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                <g fill="none" fillRule="evenodd">
                  ...
                  <g transform="translate(22.857 19.429)" strokeWidth="2">
                    ...
                    <circle className="stroke-current text-blue-400" strokeLinecap="square" cx="12.571" cy="12.571" r="3.429" />
                  </g>
                </g>
              </svg>              
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1 dark:text-black">Fast as Possible</h4>
              <p className="text-gray-600 text-center">We will do everything to make sure we deliver as fast as possible.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-inherit rounded shadow-xl dark:bg-inherit">
              ...
              <p className="text-gray-600 text-center">Security and optimization is at the heart of what we do, we deliver and we do it high impact.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-inherit rounded shadow-xl dark:bg-inherit ">
              ...
              <p className="text-gray-600 text-center">Deliver, celebrate, and do it again. That is what DevGru Solutions lives to do </p>
            </div>
